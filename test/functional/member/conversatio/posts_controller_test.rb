    ...
    context "with a logged user" do
      ...
      context "given a Blog" do
        ...
        context "on GET to :index" do
          ...
          should_assign_to :posts, :equals => '@blog.posts'
        ...
        context "on GET to :show" do
          ...
          should_assign_to :comments, :equals => '@post.all_comments'
        ...
        context "on POST to :create with correct data" do
          setup do
            post :create, :blog_id => @blog.id, :post => { :title => 'New Post', :body => 'Cool body' }, :state => 'published'
          ...
          should_assign_to :blog, :equals => '@blog'
          should_assign_to :post, :equals => "Post.find(@post_created.id)"
          should_set_the_flash_to /created/i
          should_redirect_to "member_conversatio_blog_posts_path(@blog)"
        end
        ...
        context "on PUT to :update with correct data" do
          setup do
            put :update, :blog_id => @blog.id, :id => @post.id, :post => { :title => 'Title Changed', :body => 'Body changed' }, :state => 'published'
          ...
          should_redirect_to "member_conversatio_blog_posts_path(@post.blog)"
        end
